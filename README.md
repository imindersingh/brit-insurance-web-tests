...
To set up and run the Brit Insurance Web Tests, follow the steps below:
...
In the terminal, run:
```shell
   git clone https://github.com/imindersingh/brit-insurance-web-tests.git
```
### 2. Build the project
In the terminal, run:
```shell
...
#### 4.1 Local
After the tests have completed, you can view the test report generated by Serenity.

1. Open the target/site/serenity directory in the project folder.
